...
export const fun: Module = defineModule('fun', 'commands for fun', {
  ...
  '8ball': defineCommand('8ball', '8ball', 'ask an 8ball a question', (cmd) => {
  ...
  dice: defineCommand('dice', 'dice', 'roll a dice (1-6)', (cmd) => {
